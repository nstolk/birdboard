        ...
        <div class="flex">
            <div class="flex-1 mr-4">
                <div class="mb-4">
                    ...
                    <input type="text" id="title" class="border border-muted-light py-2 text-xs block w-full rounded">
                </div>

                <div class="mb-4">
                    <label for="description" class="text-sm mb-2">Description</label>
                    <textarea type="text" id="description"
                              class="border border-muted-light py-2 text-xs block w-full rounded" rows="7"></textarea>
                </div>
            </div>
            <div class="flex-1 ml-4">
                <div class="mb-4">
                    <label class="text-sm mb-2">Need Some Tasks?</label>
                    <input type="text" class="border border-muted-light py-2 text-xs block w-full rounded"
                           placeholder="Task 1">
                </div>
